...
This template base on Flutter 3.19.6
...
- lib
    ...
    - __presentation __
        - __features__: feature
          - __blocs_: Bloc on this application or others state management
          - _page_: Screen, Page of Application, suffix: *_page*
          - _widgets_: Component reuse on this feature, suffix: *_widget*
        - _widgets_: Component reuse on this app, suffix: *_widget*
    - __utils__
